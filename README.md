...
`ocrnaut` is an OCR adaptation of the `autoresearch` idea: give an AI agent a small but real training setup, let it edit a single `train.py`, train for a fixed 5-minute budget, measure whether the run improved, keep or discard, and repeat.
