"""
One-time data preparation and fixed evaluation utilities for ocrnaut.

Downloads the ICDAR2015 cropped text-recognition benchmark from Hugging Face,
writes a small cached copy to ~/.cache/ocrnaut/, freezes the codec,
...
CACHE_DIR = Path.home() / ".cache" / "ocrnaut"
